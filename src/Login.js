        ...
        <div className="login">
            <div className="login_container">
                <div className="login_logo">
                    <img src='http://drive.google.com/uc?export=view&id=1-6Fs87V6i5MOAbrDTjinVtY_yLfUDcEW' width="300px" height="300px" alt="cit로고" />

                </div>
                <div className="login_desc">
                    <p> 리액트 연습용 홈페이지를 방문해주셔서 감사합니다! By CIT</p>
                    <h3> 최인태(CIT) 올림! </h3>
                </div>
